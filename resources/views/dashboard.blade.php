        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-600 text-sm">Total Simulaciones</div>
                        <div class="text-3xl font-bold text-gray-800">{{ $stats['total_simulations'] }}</div>
                    </div>
                </div>
                
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-600 text-sm">Favoritos</div>
                        <div class="text-3xl font-bold text-gray-800">{{ $stats['favorite_count'] }}</div>
                    </div>
                </div>
            ...
            @if($recentSimulations->count() > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-4">Simulaciones Recientes</h3>
                        <div class="space-y-3">
                            @foreach($recentSimulations as $simulation)
                                <div class="border rounded-lg p-4 hover:bg-gray-50 transition">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            <div class="font-semibold">{{ $simulation->reference_code }}</div>
            ...
            @if($favoriteSimulations->count() > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-4">Simulaciones Favoritas</h3>
